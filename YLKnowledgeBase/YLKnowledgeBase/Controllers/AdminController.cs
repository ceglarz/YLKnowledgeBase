...
namespace YLKnowledgeBase.Controllers
{
    public class AdminController : Controller
    {
        ...
        /*public AdminController(UserManager<ApplicationUser> user)
        {
            userManager = user;
        }*/
        ...
        public AdminController(UserManager<ApplicationUser> userMgr,
            ...
            IPasswordValidator<ApplicationUser> pwdValid,
            IPasswordHasher<ApplicationUser> pwdHash)
        {
            userManager = userMgr;
            userValidator = userValid;
            passwordValidator = pwdValid;
            passwordHasher = pwdHash;
        }
